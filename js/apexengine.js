$(document).ready(function() {
  ...
  db.collection("apex").orderBy("damageTotal", "desc").get().then(function(querySnapshot) {
    querySnapshot.forEach(function(doc) {
      ...
      $('.progress').hide();
      var teamCard = '<div class="card horizontal transparent z-depth-5 hoverable" style="height: 150px;"><div class="card-image"><img style="border-radius: 15px 0px 0px 15px; height: 150px; width: 200px;" src="' + doc.data().banner + '"></div><div class="card-stacked"><div class="card-content grey darken-4" style="border-radius: 0px 15px 15px 0px; padding: 10px; padding-top: 0px; padding-bottom: 0px;"><div class="row container"><div class="col m6 push-m1"><h5 class="white-text left-align"> Team ' + doc.data().teamName + ' </h5></div><div class="col m6 push-m4"><h5 class="white-text right-align hide-on-small-only"> ' + teamDamage + ' PTS</h5></div></div><div class="row" style="margin-top: -1%;"><div class="col m4 hoverable"><p class="white-text center-align" style="font-size: 15px;"> ' + doc.data().players[0].difference + ' PTS</p><p class="white-text center-align" style="font-size: 12px;"> ' + doc.data().players[0].name + '</p></div><div class="col m4 hoverable "><p class="white-text center-align" style="font-size: 15px;"> ' + doc.data().players[1].difference + ' PTS</p><p class="white-text center-align" style="font-size: 12px;"> ' + doc.data().players[1].name + '</p></div><div class="col m4 hoverable"><p class="white-text center-align" style="font-size: 15px;"> ' + doc.data().players[2].difference + ' PTS</p><p class="white-text center-align" style="font-size: 12px;"> ' + doc.data().players[2].name + '</p></div></div></div></div></div>';
